...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top">
		<div class="container-fluid">
			<img src="/bbs/img/ckworld-logo.png" alt="Logo" style="height: 60px;"
	...
	<div class="container" style="margin-top: 300px;">
		<div class="row">
			...
			<div class="col-4">
				<h3>
					<strong>로그인</strong> <span style="font-size: 0.6em;"> <a
						href="/bbs/user/register.jsp" class="ms-5"><i class="fas fa-user-plus"></i> 회원가입</a>
					</span>
				</h3>
				<hr>
