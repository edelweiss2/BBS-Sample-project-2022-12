			...
			<div class="col-sm-9">
				<table class="table table-sm table-borderless">
					<tr class="d-flex">
						...
						<td class="col-1">
							<button class="btn btn-outline-primary" type="submit" onclick="search()">검색</button>
						</td>
					</tr>
				</table>
				<hr>
				...
				<c:if test="${currentBoardPage gt 10 }">
					<li class="page-item">
						<a class="page-link" href="/bbs/board/list?page=${startPage - 1}&f=${field}&q=${query}">&laquo;</a>
					</li>
				</c:if>
